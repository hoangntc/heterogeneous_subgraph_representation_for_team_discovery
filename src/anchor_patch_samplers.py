...
def sample_structure_anchor_patches(hparams, networkx_graph, meta_paths, node_type, device, max_sim_epochs): 
    '''
    ...
    for i, node in enumerate(start_nodes):
        ...
        if hparams['structure_patch_type'] == 'ego_graph': 
            ...
            # HOANG - subgraph: list of node id
            print('Perform ego_graph walk')
            ...
            print('Perform triangular walk', i)
